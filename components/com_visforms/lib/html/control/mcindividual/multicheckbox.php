 ...
 * @since		1.6
 */
class VisformsHtmlControlMcindividualMulticheckbox extends VisformsHtmlControl
{
   ...
   public function getControlHtml ()
   {
        ...
        $html = '';
        $layout = new JLayoutFile('visforms.mcindividual.multicheckbox.control', null);
   ...
   public function createLabel()
   {
        ...
        $layout = new JLayoutFile('visforms.mcindividual.multicheckbox.label', null);
        $layout->setOptions(array('component' => 'com_visforms'));
        $html .= $layout->render(array('field' => $field));
        return $html;
   }
