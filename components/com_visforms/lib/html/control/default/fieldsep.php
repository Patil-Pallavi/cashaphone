...
/**
 * create visforms default fieldseparator HTML control
 *
 * @package		Joomla.Site
 * @subpackage	com_visforms
 * @since		1.6
 */
class VisformsHtmlControlVisformsFieldsep extends VisformsHtmlControl
{
   ...
   public function getControlHtml ()
   {
        ...
        //input
        $html = '';
        $layout = new JLayoutFile('visforms.default.fieldsep.control', null);
