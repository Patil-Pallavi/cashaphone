...
/**
 * create visforms default text HTML control
 *
 * @package		Joomla.Site
 * @subpackage	com_visforms
 * @since		1.6
 */
class VisformsHtmlControlVisformsText extends VisformsHtmlControl
{
   ...
   public function getControlHtml()
   {
        ...
        //input
        $html = '';
        $layout = new JLayoutFile('visforms.default.text.control', null);
