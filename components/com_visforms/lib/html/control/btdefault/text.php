...
/**
 * create visforms btdefault text HTML control
 *
 * @package		Joomla.Site
 * @subpackage	com_visforms
 * @since		1.6
 */
class VisformsHtmlControlBtdefaultText extends VisformsHtmlControl
{
   ...
   public function getControlHtml()
   {
       $field = $this->field->getField();       
        //input
        $html = '';
        $layout = new JLayoutFile('visforms.btdefault.text.control', null);
   ...
   public function createLabel()
   {
        ...
        $layout = new JLayoutFile('visforms.btdefault.text.label', null);
        $layout->setOptions(array('component' => 'com_visforms'));
        $html .= $layout->render(array('field' => $field));      
        return $html;
   }
