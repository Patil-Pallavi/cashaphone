...
?>
        ...
        <form action="<?php echo Juri::base(true) . '/' . htmlspecialchars($formLink, ENT_COMPAT, 'UTF-8'); ?>" method="post" name="visform" id="<?php echo $visforms->parentFormId; ?>" class="visform <?php echo $visforms->formlayout; ?> <?php echo $visforms->formCSSclass; echo (($visforms->formlayout == "bthorizontal") || ($visforms->formlayout == "bt3horizontal")) ? " form-horizontal " : "";?>"<?php if($upload == true) { ?> enctype="multipart/form-data"<?php } ?> role="form">
<?php
//add a progressbar
