  		...
  		<div class="row">
  			<div class="col-6 col-sm-6">
  				<a href="home" class="logo">
  				   <img class="img-responsive" src="images/cashaphone/logo.png" alt="Cash A Phone Logo"/>
  				</a>
  			</div>
  				...
  				<div class="searchbox">
					<form action="search-result" name="valueMobileForm" method="get" class="form-group">
						...
						<div class="form-group">
					        ...
					        <button><a href="#" class="mob_srch_icon"><img src="images/cashaphone/search.png" alt="Search"></a></button>
